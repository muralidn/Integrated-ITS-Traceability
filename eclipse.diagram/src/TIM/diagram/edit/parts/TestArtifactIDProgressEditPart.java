 ...
 * @generated
 */
public class TestArtifactIDProgressEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TestArtifactIDProgressEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.Test_2004, getParserElement(),
					TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.TestArtifactIDProgressEditPart.VISUAL_ID));
		}
		return parser;
	}
