 ...
 * @generated
 */
public class DeriveTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.DeriveTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public DeriveTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.Derive_4001, getParserElement(),
					TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.DeriveTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new DeriveLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DeriveLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DeriveLabelFigure() {
			this.setText("Derive");
		}
