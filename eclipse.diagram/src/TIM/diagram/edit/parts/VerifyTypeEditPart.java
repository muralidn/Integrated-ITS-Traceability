 ...
 * @generated
 */
public class VerifyTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.VerifyTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public VerifyTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.Verify_4003, getParserElement(),
					TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.VerifyTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new VerifyLabelFigure();
	}

	/**
	 * @generated
	 */
	public class VerifyLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public VerifyLabelFigure() {
			this.setText("Verify");
		}
