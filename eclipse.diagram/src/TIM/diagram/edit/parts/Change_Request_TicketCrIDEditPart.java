 ...
 * @generated
 */
public class Change_Request_TicketCrIDEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public Change_Request_TicketCrIDEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.Change_Request_Ticket_2008, getParserElement(),
					TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.Change_Request_TicketCrIDEditPart.VISUAL_ID));
		}
		return parser;
	}
