 ...
 * @generated
 */
public class GTMControllerCreateNewCRLtmCREditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GTMControllerCreateNewCRLtmCREditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.GTMController_2005, getParserElement(),
					TIMVisualIDRegistry
							.getType(TIM.diagram.edit.parts.GTMControllerCreateNewCRLtmCREditPart.VISUAL_ID));
		}
		return parser;
	}
