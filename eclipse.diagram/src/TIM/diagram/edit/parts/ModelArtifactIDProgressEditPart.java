 ...
 * @generated
 */
public class ModelArtifactIDProgressEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ModelArtifactIDProgressEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.Model_2003, getParserElement(),
					TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.ModelArtifactIDProgressEditPart.VISUAL_ID));
		}
		return parser;
	}
