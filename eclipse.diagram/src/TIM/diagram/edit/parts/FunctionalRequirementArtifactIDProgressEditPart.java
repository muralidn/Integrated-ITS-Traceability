 ...
 * @generated
 */
public class FunctionalRequirementArtifactIDProgressEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionalRequirementArtifactIDProgressEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.FunctionalRequirement_2002, getParserElement(),
					TIMVisualIDRegistry
							.getType(TIM.diagram.edit.parts.FunctionalRequirementArtifactIDProgressEditPart.VISUAL_ID));
		}
		return parser;
	}
