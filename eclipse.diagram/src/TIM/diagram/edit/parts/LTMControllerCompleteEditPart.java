 ...
 * @generated
 */
public class LTMControllerCompleteEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LTMControllerCompleteEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.LTMController_2006, getParserElement(),
					TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.LTMControllerCompleteEditPart.VISUAL_ID));
		}
		return parser;
	}
