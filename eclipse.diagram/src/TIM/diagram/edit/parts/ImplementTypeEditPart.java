...
import TIM.diagram.edit.policies.TIMTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ImplementTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.ImplementTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ImplementTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new TIMTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.Implement_4002, getParserElement(),
					TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.ImplementTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, TIMEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ImplementLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ImplementLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ImplementLabelFigure() {
			this.setText("Implement");
		}
