...
import TIM.diagram.edit.policies.ModelItemSemanticEditPolicy;
...
public class ModelEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ModelArtifactIDProgressEditPart) {
			((ModelArtifactIDProgressEditPart) childEditPart).setLabel(getPrimaryShape().getFigureModelLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(TIMVisualIDRegistry.getType(ModelArtifactIDProgressEditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class ModelFigure extends Ellipse {
		...
		private void createContents() {
			...
			fFigureModelLabelFigure.setForegroundColor(FFIGUREMODELLABELFIGURE_FORE);
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 0, 125, 0);

	/**
	 * @generated
	 */
	static final Color FFIGUREMODELLABELFIGURE_FORE = new Color(null, 255, 255, 255);
