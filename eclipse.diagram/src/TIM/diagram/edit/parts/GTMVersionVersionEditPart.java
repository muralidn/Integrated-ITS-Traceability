 ...
 * @generated
 */
public class GTMVersionVersionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GTMVersionVersionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.GTMVersion_2007, getParserElement(),
					TIMVisualIDRegistry.getType(TIM.diagram.edit.parts.GTMVersionVersionEditPart.VISUAL_ID));
		}
		return parser;
	}
