 ...
 * @generated
 */
public class SystemRequirementArtifactIDProgressEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SystemRequirementArtifactIDProgressEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TIMParserProvider.getParser(TIMElementTypes.SystemRequirement_2001, getParserElement(),
					TIMVisualIDRegistry
							.getType(TIM.diagram.edit.parts.SystemRequirementArtifactIDProgressEditPart.VISUAL_ID));
		}
		return parser;
	}
