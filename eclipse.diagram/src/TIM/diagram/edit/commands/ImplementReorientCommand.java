...
public class ImplementReorientCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Implement) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		Model target = getLink().getDestination();
		if (!(getLink().eContainer() instanceof GlobalTraceModel)) {
			return false;
		}
		GlobalTraceModel container = (GlobalTraceModel) getLink().eContainer();
		return TIMBaseItemSemanticEditPolicy.getLinkConstraints().canExistImplement_4002(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		GlobalTraceModel container = (GlobalTraceModel) getLink().eContainer();
		return TIMBaseItemSemanticEditPolicy.getLinkConstraints().canExistImplement_4002(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected Implement getLink() {
		return (Implement) getElementToEdit();
	}
