 ...
 * @generated
 */
public class TestItemSemanticEditPolicy extends TIMBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TestItemSemanticEditPolicy() {
		super(TIMElementTypes.Test_2004);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (TIMVisualIDRegistry.getVisualID(incomingLink) == VerifyEditPart.VISUAL_ID) {
