 ...
 * @generated
 */
public class ModelItemSemanticEditPolicy extends TIMBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ModelItemSemanticEditPolicy() {
		super(TIMElementTypes.Model_2003);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (TIMVisualIDRegistry.getVisualID(incomingLink) == ImplementEditPart.VISUAL_ID) {
