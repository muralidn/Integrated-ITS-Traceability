 ...
 * @generated
 */
public class SystemRequirementItemSemanticEditPolicy extends TIMBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public SystemRequirementItemSemanticEditPolicy() {
		super(TIMElementTypes.SystemRequirement_2001);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (TIMVisualIDRegistry.getVisualID(outgoingLink) == DeriveEditPart.VISUAL_ID) {
